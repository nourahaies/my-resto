...
export function Card({ darkMode, recipe }) {
  ...
  return (
    <div
      className={`w-full max-w-sm mx-auto rounded-lg shadow-md overflow-hidden transition-colors duration-300 flex flex-col h-full min-h-[420px] ${
        darkMode ? 'bg-gray-800' : 'bg-white'
      }`}
    >
      {/* Image */}
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        >
          {recipe.description?.slice(0, 120) || 'No description'}...
        </p>
